...
namespace ProyectoCS
{
	partial class Acercade
	{
		...
		private void InitializeComponent()
		{
			...
			this.label4.Text = "version del programa";
			// 
			// label5
			// 
			...
			this.label7.Text = "Victor Manuel Orozco Perez";
			// 
			// label8
			// 
			...
			// label11
			// 
			this.label11.Location = new System.Drawing.Point(163, 71);
			this.label11.Name = "label11";
			this.label11.Size = new System.Drawing.Size(155, 23);
			this.label11.TabIndex = 7;
			this.label11.Text = "Metodologias Agiles";
			// 
			// label12
			// 
